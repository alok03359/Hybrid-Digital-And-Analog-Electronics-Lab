...
var text = [
    "'Breadboard' also known as Prototypeboard is a type solderless electronic circuit building.A breadboard is used to build and test circuits.A breadboard image is shown below",
...
function setImg() {
    ...
    return slider_img.setAttribute("src", "Board/" + images[Current]);
}
