...
function calfreq1() {
    ...
    if (a && b && d != null) {
        var freq1 = 1440000 / ((a + 2 * b) * d);
        var dc1 = (a + b) / (a + 2 * b);

        document.getElementById('freq1').innerHTML = freq1.toFixed(4);
        document.getElementById('dc1').innerHTML = dc1.toFixed(4);
    }
...
function calfreq2() {
    ...
    if (a && b && d != null) {
        var freq2 =1440000/ ((a + 2 * b) * d);
        var dc2 = (a + b) / (a + 2 * b);

        document.getElementById('freq2').innerHTML = freq2.toFixed(4);
        document.getElementById('dc2').innerHTML = dc2.toFixed(4);
    }
}
...
function calfreq3() {
 ...
 if (a && b && d != null) {
    var freq3 = 1440000/ ((a + 2 * b) * d);
    var dc3 = (a + b) / (a + 2 * b);

    document.getElementById('freq3').innerHTML = freq3.toFixed(4);
    document.getElementById('dc3').innerHTML = dc3.toFixed(4);
 }
}
function calfreq4() {
 ...
 if (a && b && d != null) {
    var freq4 = 1440000 / ((a + 2 * b) * d);
    var dc4 = (a + b) / (a + 2 * b);

    document.getElementById('freq4').innerHTML = freq4.toFixed(4);
    document.getElementById('dc4').innerHTML = dc4.toFixed(4);
 }
}
